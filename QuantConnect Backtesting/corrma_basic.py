...
class CorrmaAlgo(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # Set the assets
        self.ind_symbol = self.AddCrypto("ETHUSD", Resolution.Daily, Market.Bitfinex).Symbol
        self.dep_symbol = self.AddCrypto("BTCUSD", Resolution.Daily, Market.Bitfinex).Symbol
